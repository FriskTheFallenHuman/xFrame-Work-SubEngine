...
public class Logger
{
    ...
    public static Action<string> loggerError = Debug.LogError;
    public static Action<string> loggerWarning = Debug.LogWarning;
    public static Action<string> loggerDebug = Debug.Log;
        ...
        if (IsChannelActive(logChannel))
        {
            ...
            switch (priority)
            {
                ...
                case Priority.Error:
                    ...
                    loggerError(finalMessage);
                    break;

                case Priority.Warning:
                    //Debug.LogWarning(finalMessage);
                    loggerWarning(finalMessage);
                    break;

                case Priority.Info:
                    //Debug.Log(finalMessage);
                    loggerDebug(finalMessage);
                    break;
            }
